...
| [0019](0019-a-device-authorization-grant-against-this-instance.md) | A device authorization grant against this instance, not against Discord | proposed |
| [0020](0020-a-device-grant-is-identity-scoped.md) | A device grant is identity-scoped and exchanges for per-membership tokens | proposed |
| [0021](0021-guild-facts-come-from-browser-flows.md) | Guild facts come from browser flows, bounded by an age | proposed |
