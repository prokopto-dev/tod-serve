...
| `circle_discord_channel` | mutable | A Discord channel bound to **one** circle: the disambiguator for a guild raiding two, and where the disclosure decision is stored. [ADR-0017](../adr/0017-a-discord-channel-binds-to-one-circle.md) |
